                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-check">
                        <input type="radio" class="form-check-input" id="exampleCheck1" name="pos_asal" value="POS ZONA 1" {{ ($simb->pos_asal  == "POS ZONA 1" )?'checked':'' }}>
                    <label class="form-check-label" for="exampleCheck1">POS ZONA 1</label>
                    </div>
                    <div class="form-check">
                    <input type="radio" class="form-check-input" id="exampleCheck2" name="pos_asal" value="POS ZONA 2" {{ ($simb->pos_asal  == "POS ZONA 2" )?'checked':'' }}>
                    <label class="form-check-label" for="exampleCheck2">POS ZONA 2</label>
                    </div>
                    <div class="form-check">
                      <input type="radio" class="form-check-input" id="exampleCheck3" name="pos_asal" value="POS ZONA 3" {{ ($simb->pos_asal  == "POS ZONA 3" )?'checked':'' }}>
                      <label class="form-check-label" for="exampleCheck3">POS ZONA 3</label>
                    </div>
                    <div class="form-check">
                      <input type="radio" class="form-check-input" id="exampleCheck4" name="pos_asal" value="POS ZONA 4" {{ ($simb->pos_asal  == "POS ZONA 4" )?'checked':'' }}>
                      <label class="form-check-label" for="exampleCheck4">POS ZONA 4</label>
                    </div>
                    <div class="form-check">
                      <input type="radio" class="form-check-input" id="exampleCheck5" name="pos_asal" value="POS ZONA 5" {{ ($simb->pos_asal  == "POS ZONA 5" )?'checked':'' }}>
                      <label class="form-check-label" for="exampleCheck5">POS ZONA 5</label>
                      </div>
                    <div class="form-check">
                      <input type="radio" class="form-check-input" id="exampleCheck6" name="pos_asal" value="POS ZONA KAWASAN" {{ ($simb->pos_asal  == "POS ZONA KAWASAN" )?'checked':'' }}>
                      <label class="form-check-label" for="exampleCheck6">POS ZONA KAWASAN</label>
                      </div>
                    <div class="form-check">
                      <input type="radio" class="form-check-input" id="exampleCheck7" name="pos_asal" value="lainnya" {{ ($simb->pos_asal  == "lainnya" )?'checked':'' }}>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="nomor_kartu" value="{{ $simb->nomor_kartu }}" class="form-control" id="exampleInputEmail1" placeholder="Jawaban Anda">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nomor HP</label>
                    <input type="text" name="no_hp" value="{{ $simb->no_hp }}" class="form-control" id="exampleInputEmail1" placeholder="Jawaban Anda">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Jam Keluar</label>
                    <input type="time" name="keluar" value="{{ $simb->keluar }}" class="form-control" id="exampleInputEmail1" placeholder="Jawaban Anda">
                  </div>
                  <div class="form-group">
                    <label>Status</label>
