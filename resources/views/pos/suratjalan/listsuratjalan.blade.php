          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <a href="{{ route('suratjalan.index') }}" class="btn btn-success"><span class="fas fa-plus"></span> Tambah SIM B</a>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-12 col-sm-6 col-lg-4">
                    <form action="{{route('pos.suratjalan.index')}}">
                      ...
                      <a href="{{route('pos.suratjalan.index')}}" class="btn btn-secondary">Reset</a>
                    ...
                    <tr>
                        ...
                        <td>
                          @if($item->verifikasi != "Terverifikasi")
                            ...
                            @endif
                            <a class="btn btn-primary" href="{{ route('pos.suratjalan.edit',$item->id) }}"><span class="fas fa-edit"></span></a>
...
<div class="modal fade" id="modal-default">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="{{ route('pos.suratjalan.destroy', ':id') }}" method="POST" class="delete-form">
            @csrf
            @method('DELETE')
